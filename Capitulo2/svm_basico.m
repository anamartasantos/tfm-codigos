...
% Descripción: Implementación didáctica de un SVM de margen duro (forma primal) 
% utilizando el optimizador CVX para ilustrar la separabilidad lineal.
...
% salida:
%   w: vector mx1. dirección normal del hiperplano
%   b: escalar. el sesgo
